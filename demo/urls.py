...
student_v7 = [
	path("students/", StudentGenericViewSet.as_view({
		"get": "list",
		"post": "create"
	})),
	re_path("^students/(?P<pk>\d+)/$", StudentGenericViewSet.as_view({
		"put": "update",
		"get": "retrieve",
		"delete": "destroy"
	}))
...
student_v8 = [
	path("students/", StudentMixinViewSet.as_view({
		"get": "list",
		"post": "create"
	})),
	re_path("^students/(?P<pk>\d+)/$", StudentMixinViewSet.as_view({
		"put": "update",
		"get": "retrieve",
		"delete": "destroy"
	}))
...
student_v9 = [
	path("students/", StudentReadOnlyViewSet.as_view({
		"get": "list",
		"post": "create"
	})),
	re_path("^students/(?P<pk>\d+)/$", StudentReadOnlyViewSet.as_view({
		"put": "update",
		"get": "retrieve",
		"delete": "destroy"
	}))
...
student_v10 = [
	path("students/", StudentModelViewSet.as_view({
		"get": "list",
		"post": "create"
	})),
	re_path("^students/(?P<pk>\d+)/$", StudentModelViewSet.as_view({
		"put": "update",
		"get": "retrieve",
		"delete": "destroy"
	}))
